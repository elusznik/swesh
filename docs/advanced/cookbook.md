...
for example [hello world](https://github.com/elusznik/swesh/blob/main/src/minisweagent/run/hello_world.py),
or the [default when calling `mini`](https://github.com/elusznik/swesh/blob/main/src/minisweagent/run/mini.py).

Want to cook up your custom version and the config is not enough?
Just follow the recipe below:

1. What's the control flow you need? Pick an [agent class](https://github.com/elusznik/swesh/blob/main/src/minisweagent/agents) (e.g., [simplest example](https://github.com/elusznik/swesh/blob/main/src/minisweagent/agents/default.py), [with human in the loop](https://github.com/elusznik/swesh/blob/main/src/minisweagent/agents/interactive.py))
2. How should actions be executed? Pick an [environment class](https://github.com/elusznik/swesh/blob/main/src/minisweagent/environments) (e.g., [local](https://github.com/elusznik/swesh/blob/main/src/minisweagent/environments/local.py), or [docker](https://github.com/elusznik/swesh/blob/main/src/minisweagent/environments/docker.py))
3. How is the LM queried? Pick a [model class](https://github.com/elusznik/swesh/blob/main/src/minisweagent/models) (e.g., [litellm](https://github.com/elusznik/swesh/blob/main/src/minisweagent/models/litellm_model.py))
4. How to invoke the agent? Bind them all together in a [run script](https://github.com/elusznik/swesh/blob/main/src/minisweagent/run), possibly reading from a [config](https://github.com/elusznik/swesh/blob/main/src/minisweagent/config) (e.g., [hello world](https://github.com/elusznik/swesh/blob/main/src/minisweagent/run/hello_world.py), or [`mini` entry point](https://github.com/elusznik/swesh/blob/main/src/minisweagent/run/mini.py))
