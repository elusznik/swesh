...
!!! note "Portkey Response API Model class"
    ...
    - [Read on GitHub](https://github.com/elusznik/swesh/blob/main/src/minisweagent/models/portkey_response_api_model.py)

    ??? note "Full source code"

        ```python
        --8<-- "src/minisweagent/models/portkey_response_api_model.py"
        ```
